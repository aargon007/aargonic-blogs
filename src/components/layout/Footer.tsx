        ...
        <footer className="bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    {/* Categories */}
                    <div>
                        <h4 className="text-sm font-semibold uppercase tracking-wide mb-4">Categories</h4>
                        <ul className="space-y-2">
                    ...
                    {/* Resources */}
                    <div>
                        <h4 className="text-sm font-semibold uppercase tracking-wide mb-4">Resources</h4>
                        <ul className="space-y-2">
